...
and pacing provides rate-based structure. That all four converge on
...
evolution system (AlphaCC)---alongside Remy's decision trees. For the main comparison,
all three were trained on a single condition
(15~Mbps, 150~ms RTT, 2~senders) and evaluated across
1--1000~Mbps. Three findings:
