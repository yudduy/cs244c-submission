...
AlphaCC's best evolved policy was
hand-translated to C++ as a native sender class.
This translation preserves the same state variables,
thresholds, and control logic; correctness was verified by
38/38 unit tests comparing outputs.
...
%% Simulator Calibration section removed — all results use C++ simulator.
